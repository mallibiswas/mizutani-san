...
def execute_Vertica_subprocess (connV_, connS_, df, outDir):
...
if __name__ == '__main__':
    ...
    timeout = 72000 # timeout for each subprocess to fetch vertica data
    
    outDir = Initialize.dataDirectory
    connV = "DRIVER=Vertica;SERVER={{}};DATABASE={0};PORT=5433;UID={1};PWD={2}".format(Initialize.sourceDB, Initialize.sourceUser, Initialize.sourcePwd)
    connS = "Driver={{SQL Server}};Server={0};Database={1};UID={2};PWD={3}".format(Initialize.targetServer, Initialize.targetDB, Initialize.targetUser, Initialize.targetPwd)    
